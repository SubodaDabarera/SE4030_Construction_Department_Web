                    ...
                    {productList.map((product, personIdx) => (
                      ...
                      >
                        ...
                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-center text-sm font-medium sm:pr-6">
                          <button onClick={() => handleOpen(product._id)} className="p-1 bg-slate-300 rounded-md mr-2 text-slate-900 hover:bg-slate-400">
                          ...
                          <button onClick={() => handleDelete(product._id)} className="p-1 bg-red-300 rounded-md text-red-900 hover:bg-red-400">
